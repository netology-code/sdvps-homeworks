...
Для выполнения этого задания требуется сгенирировать ssh ключь командой ssh-kengen. Добавит в конфигурацию terraform ключт в поле:
...
где xxx - это ключь из файла /home/"name_user"/.ssh/id_rsa.pub.
Премерная конфигурация terraform:
...
1) указать ip адресс машины в файл hosts
